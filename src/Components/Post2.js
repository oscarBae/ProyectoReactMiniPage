...
import foto1 from '../img/Post2.jpg';
            ...
            <nav aria-label="Page navigation example">
                <ul className="pagination justify-content-center">
                    <li className="page-item disabled">
                        <a className="page-item" href="./Post1" tabindex="-1" aria-disabled="true">Anterior</a>
                    </li>
                    <li className="page-item"><a className="page-item" href="./Post1">1</a></li>
                    <li className="page-item"><a className="page-item" href="Post2">2</a></li>
                    <li className="page-item"><a className="page-item" href="Post3">3</a></li>
                    <li className="page-item"><a className="page-item" href="./Post3">Siguiente</a>
                    </li>
                </ul>
            </nav>
</div>
